...
def app_icon_192() -> Response:
    return _static_binary_response("logo-icon.png", "image/png")
...
def pwa_debug(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(
        ...
        "pwa_debug.html",
            ...
            sw_url="/sw.js",
            icon_192_url="/static/logo-icon.png",
            icon_512_url="/static/logo-icon.png",
            touch_icon_url="/static/logo-icon.png",
        ),
    )
